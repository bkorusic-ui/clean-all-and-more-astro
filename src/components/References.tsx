...
const projects = [
  {
    ...
    images: [
      ...
      "/images/garden/heckenschnitt-stuttgart-ludwigsburg-uncut.webp",
      "/images/garden/heckenschnitt-stuttgart-cut3.webp",
      "/images/garden/Heckenschnitt-Ludwigsburg-Uncut.webp",
      "/images/garden/Heckenschnitt-Ludwigsburg.webp",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/references/gartenpflege-rasen-hecke2.webp",
      "/images/house/Hausmeisterservice-Treppenhaus-Stuttgart-Ludwigsburg2.webp",
      "/images/house/Hausmeisterservice-Treppenhaus-Stuttgart-Ludwigsburg3.webp",
    ],
  ...
  },
  {
    ...
    images: [
            ...
            "/images/garden/gartenpflege-rasen-hecke.webp",
            "/images/garden/gartenpflege-rasen-hecke2.webp", 
            "/images/references/rasenpflege-gartenpflege-stuttgart-1.webp",
    ],
      ...
      {selectedProject && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/85 p-5">
              <button
                ...
                className="absolute right-6 top-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md transition hover:bg-red-500"
>
              ...
              {selectedProject.images.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-6 top-1/2 z-50 flex h-14 w-14 -translate-y-1/2 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md transition hover:bg-[#789873]"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-6 top-1/2 z-50 flex h-14 w-14 -translate-y-1/2 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md transition hover:bg-[#789873]"
                  >
